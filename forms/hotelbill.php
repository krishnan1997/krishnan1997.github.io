...
$query="SELECT * FROM hotel WHERE id='$temp'";
$rec=mysqli_query($con,$query);
while($rec1=mysqli_fetch_assoc($rec))
{
    echo "<tr>";
    echo "Your TICKET ID :: <td><strong>" .$rec1['id']."</strong></td>";echo "<br>";
	echo "Checkin date :: <td><strong>" .$rec1['mode']."</strong></td>";echo "<br>";
    echo "Name :: <td><strong>" .$rec1['name']."</strong></td>";echo "<br>";
    echo "Checkout date :: <td><strong>" .$rec1['do']."</strong></td>";echo "<br>";
...
echo "<tr>";echo "</tr>";
  ...
  <form action="hotelbill.php" method="post">
  <div>
